...
class CarteiraController {
    ...
    async insertItem(dataCompra) {
        ...
        try {
            ...
            throw new Error("Insira uma data de compra Valida")
        }
    ...
    async updateHistory() {
        ...
        let dateAt = Date.parse(new Date(Date.now()).toISOString().split("T")[0] + " 00:00:00")
        let updatedAt = Date.parse(registro_carteira.updatedAt) - (3 * 60 * 60 * 1000)
